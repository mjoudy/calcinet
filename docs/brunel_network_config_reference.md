...
> (`research/experiments/ch2_connectivity/r4_probe_2d.py`, raw numbers in `research/results/regime2d/*.csv`,
...
> eta tuned per size to ~14 Hz (`research/experiments/ch2_connectivity/r4_tune_regime.py --g 8 --j-scale 1.5`).
...
> in `research/experiments/shared/wrapup_run.py`. Note eta must RISE with N to hold the rate under
...
>
> ### Presets (research/experiments/shared/wrapup_run.py)
...
> `python research/experiments/ch2_connectivity/regime_probe.py --scale n12500 --only brunel_AI_fig8B --sim-time 5000 --fig out.png`
