...
excitatory- vs inhibitory-source recall split -- see experiments/shared/r2_metrics.py), at
...
--no-save-estimates). experiments/ch1_proxy/fig_r2_rescore.py re-derives the metric set from
...
Usage (cluster or local, N=1250 is cheap):
  python experiments/ch1_proxy/fig_r2_compute.py --net n1250ai --T-ms 100000 \
