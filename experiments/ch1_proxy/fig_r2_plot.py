...
experiments/shared/r2_metrics.py) over the same camera-rate and spike-bin columns. It is
skipped automatically for an r2_data.npz produced before those columns existed.

All cosmetics live here. Saves PDF + PNG.

Usage:
  python experiments/ch1_proxy/fig_r2_plot.py --data results/fig_data/r2_data.npz --out figures/fig_R2
"""
...
# y-axis label per metric column in r2_data.npz (see experiments/shared/r2_metrics.py).
MEASURE_LABEL = {
    "auc": "ROC-AUC",
    "corr": "correlation",
    "precision": "precision",
