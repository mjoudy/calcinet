...
experiments/ch2_connectivity/linearity_overall_metrics.py, whose numbers this plots).
...
Usage:
  python experiments/ch2_connectivity/fig_linearity_overall_metrics.py --out figures/fig_linearity_overall_metrics
"""
