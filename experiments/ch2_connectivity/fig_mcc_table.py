...
Usage:
  python experiments/ch2_connectivity/fig_mcc_table.py --root results --method ols --tpick longest
  python experiments/ch2_connectivity/fig_mcc_table.py --root results --tpick matched-tn --tn 4000
"""
