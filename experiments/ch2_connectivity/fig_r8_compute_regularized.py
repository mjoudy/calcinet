...
n_<class>, ...) so the existing experiments/ch2_connectivity/fig_r8_violin_fpsplit.py plot script
works unchanged on the output.

Usage:
  python experiments/ch2_connectivity/fig_r8_compute_regularized.py --method lasso
  python experiments/ch2_connectivity/fig_r8_compute_regularized.py --method lassodale
"""
