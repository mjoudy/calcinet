...
Usage:
  python experiments/ch2_connectivity/fig_r8_violin.py --data ~/calcium_results/r8/r8_wrapup_n12500r4_T5000k.npz \
      --out figures/fig_R8_violin_n12500
  python experiments/ch2_connectivity/fig_r8_violin.py --metric asymc --data <r8_*.npz> \
