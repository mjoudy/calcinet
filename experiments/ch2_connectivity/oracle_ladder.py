...
Usage
-----
    python experiments/ch2_connectivity/oracle_ladder.py
    python experiments/ch2_connectivity/oracle_ladder.py --dataset results/solver_comparison_N100/dataset
    python experiments/ch2_connectivity/oracle_ladder.py --lags 5,10,15,20,30,50
"""
