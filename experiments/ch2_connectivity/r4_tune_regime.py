...
N=12500):
  srun --cpus-per-task=8 --mem=16G --time=00:30:00 \
    $(ws_find calcium_ar)/env/bin/python experiments/ch2_connectivity/r4_tune_regime.py --target 14
"""
...
def main():
    ...
    # (experiments/ch2_connectivity/r4_probe_2d.py): at a fixed 14 Hz, CV rises with both g and J.
