...
through the full wrap-up pipeline (experiments/shared/wrapup_run.py) separately.

Usage:
  python experiments/ch2_connectivity/regime_scan.py                       # default grid, N=1250
  python experiments/ch2_connectivity/regime_scan.py --sim-time 5000 --seeds 1
  python experiments/ch2_connectivity/regime_scan.py --out $CALCIUM_AR_WORKDIR/results/regime_scan
"""
