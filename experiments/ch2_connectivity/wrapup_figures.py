"""
Wrap-up figures. Reads the per-seed estimates written by experiments/shared/wrapup_run.py
...
Usage:  python experiments/ch2_connectivity/wrapup_figures.py --data results/wrapup_local
        python experiments/ch2_connectivity/wrapup_figures.py --data $WS/results/wrapup_n1250 \
...
def load():
    ...
    seeds = seed_dirs()
    if not seeds:
        raise SystemExit(f"No seed data under {DATA}. Run experiments/shared/wrapup_run.py first.")
