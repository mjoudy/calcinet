...
Usage:
  python experiments/ch2_connectivity/wrapup_run_stream.py --net n1250ai --sweep 500000 1000000 2000000 --seeds 1 2 3
  python experiments/ch2_connectivity/wrapup_run_stream.py --net n1250ai --sweep 20000 50000 --seeds 1   # local check
"""
