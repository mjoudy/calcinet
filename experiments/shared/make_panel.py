...
_raster / _calcium are kept here because experiments/shared/network_stats.py imports them.

Usage:
    python experiments/shared/make_panel.py <run_dir> [--stage EN|EN+Dale|EN+Dale+balance] [--out fig.png]
"""
...
# --------------------------------------------------------------------------- #
# network-signal helpers (used by experiments/shared/network_stats.py)
# --------------------------------------------------------------------------- #
