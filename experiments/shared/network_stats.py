...
Usage:
    python experiments/shared/network_stats.py <dataset_dir> [--n-exc 1000] [--dt 0.1] [--out fig.png]
e.g. python experiments/shared/network_stats.py $(ws_find calcium_ar)/data/N1250/s1_tau100_T50000
"""
