...
Usage:  python experiments/shared/wrapup_run.py                       # N=100 local, seeds 1 2 3
        python experiments/shared/wrapup_run.py --net n1250 --seeds 1 2 3 4 5
        python experiments/shared/wrapup_run.py --net n1250 --out /path/to/results/wrapup_n1250
...
# realistic ~8 Hz (CV 0.80, synchrony 0.027). See experiments/ch2_connectivity/regime_scan.py.
#
...
NETS = {
    ...
    # tuned per size to ~14 Hz (experiments/ch2_connectivity/r4_tune_regime.py --g 8 --j-scale 1.5).
    #
    ...
    # experiments/ch2_connectivity/pif_tau_probe.py --stage x100 (2026-08-15, sim_time=40000ms,
