...
excitatory- vs inhibitory-source recall split -- see research/experiments/shared/r2_metrics.py), at
...
--no-save-estimates). research/experiments/ch1_proxy/fig_r2_rescore.py re-derives the metric set from
...
Usage (cluster or local, N=1250 is cheap):
  python research/experiments/ch1_proxy/fig_r2_compute.py --net n1250ai --T-ms 100000 \
...
from calcinet.proxy.signal_utils import smooth_signal
...
def iter_calcium(idx, tms, N, dt, tau, T_ms, deconv, frame_ms, chunk, rng, phase=0):
    ...
    extra information when reused (see docs/lab_notebook/notebook.md)."""
