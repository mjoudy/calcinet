...
Idea (see docs/lab_notebook/notebook.md): a camera at a given frame interval
...
Usage:
  python research/experiments/ch1_proxy/fig_r2_phase_avg.py --net n1250_r4 --T-ms 500000 \
