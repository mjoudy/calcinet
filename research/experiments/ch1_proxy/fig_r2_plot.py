...
research/experiments/shared/r2_metrics.py) over the same camera-rate and spike-bin columns. It is
skipped automatically for an r2_data.npz produced before those columns existed.

All cosmetics live here. Saves PDF + PNG.

Usage:
  python research/experiments/ch1_proxy/fig_r2_plot.py --data results/fig_data/r2_data.npz --out figures/fig_R2
"""
...
# y-axis label per metric column in r2_data.npz (see research/experiments/shared/r2_metrics.py).
MEASURE_LABEL = {
    "auc": "ROC-AUC",
    "corr": "correlation",
    "precision": "precision",
...
def _ceiling(ax, z, measure):
    """Used only by ratio_panel now -- rate_panel/tau_panel/spike_panel dropped
    this overlay as redundant with the spike-bin panel's own peak."""
