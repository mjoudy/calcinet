...
research/experiments/ch2_connectivity/linearity_overall_metrics.py, whose numbers this plots).
...
Usage:
  python research/experiments/ch2_connectivity/fig_linearity_overall_metrics.py --out figures/fig_linearity_overall_metrics
"""
...
# src/calcinet/simulation/hawkes_ground_truth.py rate check + local ISI-CV measurement for
# Hawkes).
RATE_CV = {
    "LIF": (14.8, 0.98),
...
def main():
    ...
    axRate.set(yticks=y, yticklabels=[], xlabel="mean firing rate [Hz]",
