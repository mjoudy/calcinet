...
Usage:
  python research/experiments/ch2_connectivity/fig_linearity_way2.py --out figures/fig_linearity_way2
"""
...
DEFAULT_SOURCES = [
    ...
    ("PIF pilot (tau_m x10)",
     ...
     "#e8a33d"),
    # tau_m x100 (2000ms), eta=80.0 from research/experiments/ch2_connectivity/pif_tau_probe.py --stage x100
    ...
    # src/calcinet/simulation/hawkes_ground_truth.py / hawkes_to_moments.py).
