...
(research/experiments/ch2_connectivity/r4_tune_regime.py): one regime (g=8, V_reset=10, J fluctuation-scaled
...
Usage:
  python research/experiments/ch2_connectivity/fig_r4_ladder_stability.py --out figures/fig_r4_ladder_stability
"""
