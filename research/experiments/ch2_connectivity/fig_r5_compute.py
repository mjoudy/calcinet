...
lambda grid, and scores each with the SAME scorer as R.4 (src/calcinet/connectivity/analyze_run.py)
...
RUN:
  ...
  python research/experiments/ch2_connectivity/fig_r5_compute.py --root results --net n1250r4 --device cpu
  # N=12500 (large, GPU): see research/slurm/run_r5.slurm
"""
...
from calcinet.connectivity.analyze_run import edge_index, score, FIELDS as SCORE_FIELDS
