...
calcinet.connectivity.solvers.from_moments — no resimulation, no raw feed, N=1250 only,
~1-2 min on CPU. Uses:
...
n_<class>, ...) so the existing research/experiments/ch2_connectivity/fig_r8_violin_fpsplit.py plot script
works unchanged on the output.

Usage:
  python research/experiments/ch2_connectivity/fig_r8_compute_regularized.py --method lasso
  python research/experiments/ch2_connectivity/fig_r8_compute_regularized.py --method lassodale
"""
...
from calcinet.connectivity.analyze_run import edge_index
from calcinet.connectivity.solvers.from_moments import (
