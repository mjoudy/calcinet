...
Usage:
  python research/experiments/ch2_connectivity/fig_r8_plot.py --data ~/calcium_results/r8/r8_wrapup_n12500r4_T5000k.npz \
...
def main():
    ...
    fig.suptitle(f"Directional asymmetry vs false positives at N={N} "
                 "(single-lag OLS): does filtering by symmetry improve precision?",
