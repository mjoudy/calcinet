...
Usage:
  python research/experiments/ch2_connectivity/fig_r8b_plot.py --data ~/calcium_results/r8b/r8b_n12500_r4.npz \
...
def main():
    ...
    fig.suptitle(f"Direction and timing are separate axes at N={N}: "
                 "symmetry vs multi-lag profile",
