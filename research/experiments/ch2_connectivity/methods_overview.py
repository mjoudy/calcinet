...
docs/lab_notebook/methods_overview.md (and the ledger).
...
Usage:  python research/experiments/ch2_connectivity/methods_overview.py
"""
...
DOC = "docs/lab_notebook/methods_overview.md"
NE = 80
LAG = 15
