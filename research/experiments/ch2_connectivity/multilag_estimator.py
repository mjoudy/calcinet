...
Usage (cluster; needs cached ground-truth spikes under --cache-dir):
  python research/experiments/ch2_connectivity/multilag_estimator.py --net n1250_r4 \
...
sys.path.insert(0, str(ROOT)); sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "shared"))
