...
Usage
-----
    python research/experiments/ch2_connectivity/oracle_ladder.py
    python research/experiments/ch2_connectivity/oracle_ladder.py --dataset results/solver_comparison_N100/dataset
    python research/experiments/ch2_connectivity/oracle_ladder.py --lags 5,10,15,20,30,50
"""
...
from calcinet.simulation import simulate_calcium
