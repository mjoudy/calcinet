...
through the full wrap-up pipeline (research/experiments/shared/wrapup_run.py) separately.

Usage:
  python research/experiments/ch2_connectivity/regime_scan.py                       # default grid, N=1250
  python research/experiments/ch2_connectivity/regime_scan.py --sim-time 5000 --seeds 1
  python research/experiments/ch2_connectivity/regime_scan.py --out $CALCIUM_AR_WORKDIR/results/regime_scan
"""
...
from calcinet.proxy.signal_utils import calculate_cv
