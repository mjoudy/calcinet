...
Run as a SLURM job (it re-solves 3× + a Dale solve):
    python research/experiments/ch2_connectivity/run_ladder.py
"""
...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "shared"))  # make_panel
...
from calcinet.connectivity.postprocessing import strongest_entry_types
