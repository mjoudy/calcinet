...
Submit (exact commands in research/slurm/run_experiments.slurm):
...
Run one locally:  SWEEP=lag TASK=0 python research/experiments/ch2_connectivity/run_n1250_experiments.py
"""
...
from calcinet.connectivity.solvers import dale_fista
from calcinet.connectivity.postprocessing import strongest_entry_types, rescale_balance_nz
