...
Data provenance (OLS, seed 1):
  ...
  N=1250  n1250ai   (~8 Hz, V_r=0)   : research/experiments/ch2_connectivity/recovery_curve.py sweep
Recorded here so the figure can be redrawn without the cluster.

Usage:  python research/experiments/ch2_connectivity/scaling_curve.py [--out fig.png]
"""
