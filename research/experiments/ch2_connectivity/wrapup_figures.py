"""
Wrap-up figures. Reads the per-seed estimates written by research/experiments/shared/wrapup_run.py
...
Usage:  python research/experiments/ch2_connectivity/wrapup_figures.py --data results/wrapup_local
        python research/experiments/ch2_connectivity/wrapup_figures.py --data $WS/results/wrapup_n1250 \
...
from calcinet.framework import thresholding as T
...
def load():
    ...
    seeds = seed_dirs()
    if not seeds:
        raise SystemExit(f"No seed data under {DATA}. Run research/experiments/shared/wrapup_run.py first.")
