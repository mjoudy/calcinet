...
Usage:
    python research/experiments/shared/plot_sweeps.py <sweep_dir> [--out fig.png]
e.g. python research/experiments/shared/plot_sweeps.py $(ws_find calcium_ar)/results/n1250_sweeps/lag
"""
