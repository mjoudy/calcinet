...
Usage:  python research/experiments/shared/wrapup_run.py                       # N=100 local, seeds 1 2 3
        python research/experiments/shared/wrapup_run.py --net n1250 --seeds 1 2 3 4 5
        python research/experiments/shared/wrapup_run.py --net n1250 --out /path/to/results/wrapup_n1250
...
from calcinet.connectivity.solvers import solve_ols, solve_fista
from calcinet.connectivity.solvers.dale_fista import dale_fista
...
# realistic ~8 Hz (CV 0.80, synchrony 0.027). See research/experiments/ch2_connectivity/regime_scan.py.
#
...
NETS = {
    ...
    # tuned per size to ~14 Hz (research/experiments/ch2_connectivity/r4_tune_regime.py --g 8 --j-scale 1.5).
    #
    ...
    # research/experiments/ch2_connectivity/pif_tau_probe.py --stage x100 (2026-08-15, sim_time=40000ms,
