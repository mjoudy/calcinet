...
Usage:
    python -m calcinet.connectivity.analyze_run --data $WS/results/wrapup_n12500ai_T1000k
    python -m calcinet.connectivity.analyze_run --data results/wrapup_n1250ai_T500k --density 0.10
"""
