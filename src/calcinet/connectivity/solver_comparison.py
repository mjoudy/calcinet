...
Usage
-----
    python -m calcinet.connectivity.solver_comparison                         # N=100 defaults
    python -m calcinet.connectivity.solver_comparison --ne 1000 --ni 250     # N=1250
    python -m calcinet.connectivity.solver_comparison --data-path my_ds/ --solvers ols ridge
