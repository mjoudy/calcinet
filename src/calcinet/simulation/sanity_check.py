...
-----
    ...
    # N=1000 (full run)
    python -m calcinet.simulation.sanity_check --ne 800 --ni 200 --sim-time 30000

    # Override J_ex manually (skip auto-scaling)
    python -m calcinet.simulation.sanity_check --ne 80 --ni 20 --j-ex 1.0

    # Custom output folder
    python -m calcinet.simulation.sanity_check --ne 80 --ni 20 --out results/sanity_n100
...
from calcinet.simulation import BrunelNetwork, simulate_calcium
